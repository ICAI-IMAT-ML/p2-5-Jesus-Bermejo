...
class LogisticRegressor:
    ...
    def fit(
        ...
        """
        # DONE Obtain m (number of examples) and n (number of features)
        m = X.shape[0]
        n = X.shape[1]

        # DONE Initialize all parameters to 0
        self.weights = np.zeros(n)
        self.bias = 0

        # DONE Complete the gradient descent code
    ...
    def predict_proba(self, X):
        ...
        # DONE z is the value of the logits. Write it here (use self.weights and self.bias):
    ...
    def ridge_regularization(self, dw, m, C):
        ...
        """
        Es la única manera de que los tests salgan correctos, pero estoy bastante seguro que reidge_gradient debería tener un 2 multiplicando
        """
    ...
    def elasticnet_regularization(self, dw, m, C, l1_ratio):
        ...
        """
        La descripción del método está mal redactada. Mirar ridge para comentario sobre implementación.
        """
        elasticnet_gradient = (l1_ratio)*self.lasso_regularization(0,m,C) + (1-l1_ratio)*self.ridge_regularization(0,m,C)
    ...
    def log_likelihood(y, y_hat):
        ...
        # DONE: Implement the loss function (log-likelihood)
    ...
    def sigmoid(z):
        ...
        # DONE: Implement the sigmoid function to convert the logits into probabilities
